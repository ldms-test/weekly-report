...
* [ldmsd_stream_test2](test-log/ldmsd_stream_test2.log): $\textcolor{red}{\text{FAILED}}$
...
* [set_sec_mod_test](test-log/set_sec_mod_test.log): $\textcolor{red}{\text{FAILED}}$
* [dump_cfg_test](test-log/dump_cfg_test.log): $\textcolor{red}{\text{FAILED}}$
...
* [ldmsd_decomp_static_rowcache_test](test-log/ldmsd_decomp_static_rowcache_test.log): $\textcolor{red}{\text{FAILED}}$
